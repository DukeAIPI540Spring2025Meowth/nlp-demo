...
class Evaluator:
    ...
    def evaluation_by_criteria_ref_free(self, prompt):
        # Model selection
        available_models = [self.generate_naive, self.generate_deep, self.generate_traditional]
...
def main():
    ...
    evaluation_results = evaluator.evaluation_by_criteria_ref_free(prompt)
